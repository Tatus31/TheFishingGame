...
public class RopeController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // Adjust the number of sections to make the rope smaller
        int numberOfSections = 4; // Reduced number of rope sections
        ...
        // Add the rope sections from bottom to top (more sections can be added for a longer rope)
